...
const locations = [
  ...
  {
    name: "kill monster",
    "button text": ["Go to town square", "Fight Again", "Play Easter Egg"],
...
function sellWeapon() {
  if (inventory.length > 1) {
    gold += 15;
    goldText.innerText = gold;
    let currentWeapon = inventory.shift();  //returns the item that's being removed from the original array
